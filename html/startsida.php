...
<head>
    ...
    <link rel="stylesheet" href="../sass/startsida.css">
</head>
...
<body>
    <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="startsida.php">Startsida<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="feed">
            <div class="row">
                <div class="col">
                    <h1 class="text-center">Välkommen till</h1>
                    <h1 class="text-center">Drönarfoton.Se</h1>
                </div>
            </div>
        </div>

        <footer class="page-footer border-top fixed-bottom">
    ...
    <script src="../js/startsida.js"></script>
</body>
